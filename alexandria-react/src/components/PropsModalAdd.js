...
export default function PropsModalAdd(props) {
    ...
    const [user_id, setUser_id] = useState(JSON.parse(localStorage.getItem('user')));
            ...
            <Modal.Body>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group controlId="formBasicState">
                        ...
                        <Form.Control type="purchasePrice" placeholder="Purchase Price" onChange={e => setPurchasePrice(e.target.value)} />
                    </Form.Group>
                    <Form.Group controlId="formBasicState">
                        <Form.Label>Montly Rent *</Form.Label>
                        <Form.Control type="montlyRent" placeholder="Monthly Rent" onChange={e => setRent(e.target.value)} />
                    </Form.Group>
