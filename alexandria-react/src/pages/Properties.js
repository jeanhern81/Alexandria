...
class Properties extends Component {
    ...
    render() {
        ...
        return (
            ...
            <br></br>
                <div>
                <Button className='propertyDetails' variant="info" size="sm" to='/PropertyDetails' onClick={() => this.setState({ addPropertyDetailsModalShow: true })}>Property Details </Button>
